...
type ProductServiceClient interface {
	GetProducts(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*Products, error)
	...
	UpdateProduct(ctx context.Context, in *UpdateDataProduct, opts ...grpc.CallOption) (*Status, error)
...
func (c *productServiceClient) GetProducts(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*Products, error) {
...
func (c *productServiceClient) UpdateProduct(ctx context.Context, in *UpdateDataProduct, opts ...grpc.CallOption) (*Status, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Status)
...
type ProductServiceServer interface {
	GetProducts(context.Context, *Filter) (*Products, error)
	GetProduct(context.Context, *Id) (*Product, error)
	CreateProduct(context.Context, *Product) (*Id, error)
	UpdateProduct(context.Context, *UpdateDataProduct) (*Status, error)
...
func (UnimplementedProductServiceServer) GetProducts(context.Context, *Filter) (*Products, error) {
...
func (UnimplementedProductServiceServer) UpdateProduct(context.Context, *UpdateDataProduct) (*Status, error) {
...
func _ProductService_GetProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProducts(ctx, req.(*Filter))
	}
...
func _ProductService_UpdateProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).UpdateProduct(ctx, req.(*UpdateDataProduct))
	}
	return interceptor(ctx, in, info, handler)
}
